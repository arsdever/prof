...
namespace prof
{
    ...
    public:
        ...
        /**
         * @brief Get the longest frame for the given thread.
         *
         * @param thread_id the id of the thread to get the data for.
         * @return const frame* the longest frame for the given thread.
         */
        static const frame* longest_frame(std::string_view thread_id);
